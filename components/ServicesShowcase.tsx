							...
							>
								...
								>
									...
									<div className="mt-6 space-y-2">
										<h4 className="text-md font-semibold bg-gradient-to-r from-red-600 to-red-400 bg-clip-text text-transparent">
											{service.title}
										</h4>
										<p className="text-xs leading-relaxed text-slate-600">{service.description}</p>
									</div>
								</article>
							</div>
						))}
